...
import { ProTableProps } from "@/proTable/index.vue";
...
export interface ProTableRefProps {
	getTableList?: (params?: {
		manualParam?: Record<string, any>;
		manualApi?: (...params: [any, any] | (Record<string, any> | undefined)[]) => Promise<unknown>;
	}) => void;
	element?: InstanceType<typeof ElTable>;
	tableData?: any[];
}
